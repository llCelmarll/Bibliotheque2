...
class TestBookServiceExternalData:
    ...
    def _make_book_service_with_mocks(self, book_service, test_user):
        """Configure les mocks communs sur book_service pour scan_book (livre absent en DB)."""
        book_service.book_repository = Mock()
    ...
    @pytest.mark.asyncio
    async def test_scan_book_google_books_is_dict_not_tuple(self, book_service, test_user):
    ...
    @pytest.mark.asyncio
    async def test_scan_book_open_library_is_dict_not_tuple(self, book_service, test_user):
    ...
    @pytest.mark.asyncio
    async def test_scan_book_external_api_error_returns_none(self, book_service, test_user):
